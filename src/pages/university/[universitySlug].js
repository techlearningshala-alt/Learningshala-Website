...
import {
  getUniversityData,
  getUniversityDetailData,
} from "@/services/UniversitypageService";
import React from "react";

// export async function getStaticPaths() {
//   const res = await getUniversityData();
//   const universityList = (await res?.data?.data?.data) || null;
//   const paths = universityList.map((university) => ({
//     params: { universitySlug: university.university_name },
//   }));
...
export async function getStaticPaths() {
  ...
  const paths = universityList.map((university) => ({
    params: { universitySlug: university.university_slug },
  }));
  return { paths, fallback: false };
}
...
export async function getStaticProps({ params }) {
  ...
  const res = await getUniversityDetailData(params);
  const universityDetailData = (await res?.data?.data?.data) || null;
  return {
    props: {
      universityDetailData: universityDetailData,
...
const University = ({ screenSize, universityDetailData,universitiesList }) => {
  ...
  //       props: {
  //         content: `<p>
  //               Old NIRF 2025 Rankings are out. As per the latest NIRF 2025 rankings,
  ...
  //     {
  //       id: "approval-logo",
  //       title: "University Approval Logo",
  //       component: "UniversityApprovalLogos",
  //       props: {
  //         universityLogo:
  //           "/images/university_list/1_amity-online-university-logo.jpg",
  //         universityName: "Amity University Online",
  ...
  //     {
  //       id: "placement-detail",
  //       title: "Placements Details",
  //       component: "UniversityPlacement",
  //       props: {
  ...
  //       component: "UniversitySampleCertificate",
  //       props: {
  //         content: `  <ul>
  //           <li>
  //               <p>In an age where people skim through content rather than reading it in-depth, bullet points have become an essential tool for improving readability. By using short, clear statements, bullet points allow the reader to quickly absorb key information without getting bogged down by long paragraphs.</p>
  ...
  //         </ul>`,
  //         sampleImg:
  //           "/images/sample-certificate/amity-online-new-sample-degree.webp",
  //       },
  //     },
  //     {
  ...
  //     </table>`,
  //         emiPartners: [
  //           { name: "Fibe India", img: "/images/loan/fibe-india.svg" },

  //           { name: "Lazy", img: "/images/loan/lazy.svg" },
  //           { name: "MoneyView", img: "/images/loan/moneyview.svg" },
  //         ],
  //       },
  //     },
  //     {
  ...
  //     },
  //     {
  //       id: "university-latest-articles",
  //       title: "University Latest Articles",
  //       component: "UniversityLatestArticles",
  //       props: {
  //         allArticles: [
  //           {
  ...
  //     },
  //     {
  //       id: "university-Other-popular-colleges",
  ...
  //                 id: "1",
  //                 question:
  //                   "How should I judge if this course is actually right for me?",
  //                 answer:
  ...
  //                 id: "2",
  //                 question:
  //                   "How do I know if a university's '100% placement' promise is real?",
  //                 answer:
  ...
  //                 id: "3",
  //                 question:
  //                   "ssHow can I be sure I'm not overpaying for my degree?",
  //                 answer:
  ...
  return (
    <div>
      ...
      />
      <div className="bg-gray-100 py-4 md:py-10 sec_mb">
            ...
            <div className="col-span-12 md:col-span-9">
              <p className="mb-3 text-sm">
                ...
                <span className="font-bold">
                  {formatDate(universityDetailData?.updated_at)}
                </span>{" | "}
                by {universityDetailData?.author_name}
              </p>
            </div>
          </div>
          <div className="grid grid-cols-12 gap-4">
            <div className="col-span-12 lg:col-span-3">
              <Toc sections={universityDetailData?.sections} />
            </div>
            <div className="col-span-12 lg:col-span-9">
              {universityDetailData?.sections?.map(
                ({ id, title, component, ...props }) => {
                  const Component = universitySectionMap[component];
                  if (!Component) {
                    console.warn(
                      `⚠️ Component not found for section: ${component}`
                    );
                    return null;
                  }
                  return (
                    <Component
                      ...
                      title={title}
                      // universityDetailData={universityDetailData}
                      universityData={universityDetailData}
                      universitiesList={universitiesList}
                      {...props}
                    />
                  );
